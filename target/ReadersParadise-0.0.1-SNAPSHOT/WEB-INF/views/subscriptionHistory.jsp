	...
	<div class="container">
		...
		<div class="row clearfix">
			...
			<div class="col-lg-12">
				<ol class="nav nav-tabs">
					...
					<li><a href="user_Recommendations.html">Books Recommended for You</a></li>
					<li class="active"><a href="user_SubscriptionHistory">Subscriptions
							History</a></li>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<c:if test="${not empty showSubscriptionHistory}">
			...
			cellspacing="0">
						...
						<tbody>
							...
							<c:forEach var="s" items="${subscriptionhistory}">

								<tr class="success">

									<td>${s.planName}</td>
									<td>${s.maxBooks}</td>
									<td>${s.maxDays}Days</td>
									<td>${s.price}</td>
									<td>${s.startDate}</td>
									<td>${s.endDate}</td>
