...
<%@page import=" static in.co.impetus.constants.Constants.*"%>
<%
	...
	<div class="container">
		...
		<div class="row clearfix">
			...
			<div class="col-lg-12">
				<ol class="nav nav-tabs">
					...
					<li class="active"><a href="user_showRequestedBooks.html">Requested
							Books</a></li>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<!-- 
		Requested Books will be displayed Here:
	 -->
				<c:if test="${not empty showRequestedBooks}">
			...
			cellspacing="0">
						...
						<tbody>
							...
							<c:forEach var="s" items="${requestedBooks}">
								...
								<c:if test="${s.deliveryStatus != 'Cancelled'}">
									<c:if test="${s.deliveryStatus != 'Delivered'}">
										<c:if test="${s.deliveryStatus != 'Denied'}">
											<tr class="success">
												<form action="user_cancelDeliveryRequest" method="GET">
													<td><img
													...
													<c:if test="${s.deliveryStatus != 'Cancelled'}">
														<td><input type="submit"
															class="btn btn-danger btn-sm" id="button" name="button"
															value="Cancel Request" /></td>
													</c:if>
													<c:if test="${s.deliveryStatus == 'Cancelled'}">
														<td><input type="submit"
															class="btn btn-danger btn-sm" id="button" name="button"
															value="Cancel Request" disabled /></td>
													</c:if>
