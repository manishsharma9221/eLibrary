	...
	<div class="container">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<p>We are having a huge collection of the popular books. Our
							colllection of books is periodically updated with respect
							to demands by our custormers.</p>
						<p>
						<hr>
						</p>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>The Readers Paradise website is developed and managed by Manish
					Sharma .You can contact manish.sharma@impetus.co.in for any further
					enquiry.</p>
			</div>
			<div class="col-md-6">
    ...
    %></B>
			...
			<div class="col-md-4">
				<a class="btn btn-block btn-social btn-linkedin"
					href="https://in.linkedin.com/in/manishsharma"> <i class="fa fa-linkedin"></i>
